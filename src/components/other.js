                    ...
                    <div className="flex justify-center mx-auto">
                        <div className="px-3">
                            ...
                            <div className="mt-5 grid grid-cols-1 gap-2 pl-1 text-white">
                                ...
                                <a href="https://maps.app.goo.gl/bue3xGxnRnUVScQr5?g_st=com.google.maps.preview.copy" target="_blank" className="w-fit hover:text-[#EFCF77] hover:scale-[105%] duration-300 flex">
